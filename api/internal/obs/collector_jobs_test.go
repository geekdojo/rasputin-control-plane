...
func TestDecideCollectorActions(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			act := decideCollectorActions(nodes, depState, tearState, tt.on, now, func(string) bool { return true }, noWant)
...
func TestDecideCollectorActions_MixedFleet(t *testing.T) {
	...
	act := decideCollectorActions(nodes, depState, map[string]*nodeJobState{}, true, now, func(string) bool { return true }, noWant)
